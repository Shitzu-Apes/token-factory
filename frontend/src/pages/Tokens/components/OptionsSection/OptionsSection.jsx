...
const OptionsSection = ({
  ...
  const tokenIdClass = () => {
    if (!state.tokenId || (isValidTokenId(state.tokenId) && state.tokenLoading)) {
      return 'form-control form-control-large';
    } else if (isValidTokenId(state.tokenId) && !state.tokenAlreadyExists) {
  ...
  const ownerIdClass = () => {
    if (!state.ownerId || (isValidAccountId(state.ownerId) && state.accountLoading)) {
      return 'form-control form-control-large';
    } else if (isValidAccountId(state.ownerId) && state.accountExists) {
      return 'form-control form-control-large is-valid';
    } else {
      return 'form-control form-control-large is-invalid';
    }
  ...
  return !state.connected && state.creating ? (
    ...
    <div>
      ...
      <div>
        <button className="btn btn-success" onClick={() => requestWhitelist(state.tokenId)}>
        ...
        <div>
          ...
          <div className="form-group">
            ...
            <small>
              ...
              <code>{state.tokenId ? state.tokenId.toLowerCase() + '.' + ContractName : ''}</code>
            </small>
          </div>
          <div className="form-group">
          ...
          <div className="form-group">
            ...
            <small>
              ...
              <code>1 / 10**{state.tokenDecimals}</code> is the smallest fractional value of the new
              token.
            </small>
          </div>
          <div className="form-group">
